#!/usr/bin/env python3
"""
Генератор исправленного дашборда с рабочими графиками
"""
...
def generate_fixed_dashboard_v2():
    """Генерирует исправленный дашборд с рабочими графиками"""
...
"""
    ...
    for i, (_, hotel) in enumerate(all_hotels.iterrows()):
        ...
        # Экранируем кавычки в названии отеля
...
"""
    ...
    print(f"✅ Исправленный дашборд v2 сгенерирован: index.html")
