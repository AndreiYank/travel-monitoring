#!/usr/bin/env python3
"""
Дашборд с поддержкой сравнения аэропортов
"""
...
def generate_dashboard_with_airport_comparison(
    data_file: str = 'data/travel_prices.csv', 
    output_file: str = 'index.html', 
    title: str = 'Travel Price Monitor • Сравнение аэропортов',
    charts_subdir: str = 'hotel-charts', 
    tz: str = 'Europe/Warsaw', 
    alerts_file: str = None,
    airport_comparison_file: str = None
):
    """Генерирует дашборд с поддержкой сравнения аэропортов"""
...
def main():
    """Главная функция"""
    import argparse
    parser = argparse.ArgumentParser(description='Generate dashboard with airport comparison')
    parser.add_argument('--data-file', default='data/travel_prices.csv')
    parser.add_argument('--output', default='index.html')
    parser.add_argument('--title', default='Travel Price Monitor • Сравнение аэропортов')
