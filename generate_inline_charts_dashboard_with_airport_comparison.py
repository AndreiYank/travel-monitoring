...
Модифицированная версия оригинального дашборда
"""
...
def generate_inline_charts_dashboard_with_airport_comparison(data_file: str = 'data/travel_prices.csv', output_file: str = 'index.html', title: str = 'Travel Price Monitor • Расширенный дашборд', charts_subdir: str = 'hotel-charts', tz: str = 'Europe/Warsaw', alerts_file: str = None, airport_comparison_file: str = None):
...
def main():
    """Главная функция"""
    import argparse
    parser = argparse.ArgumentParser(description='Generate inline charts dashboard with airport comparison')
    ...
    generate_inline_charts_dashboard_with_airport_comparison(
