#!/usr/bin/env python3
"""
Ультра-простой генератор дашборда - без модальных окон
"""
...
def generate_ultra_simple_dashboard():
    """Генерирует ультра-простой дашборд без модальных окон"""
...
<body>
    ...
    <script>
        // Только основной график - никаких модальных окон
    ...
    print(f"✅ Ультра-простой дашборд сгенерирован: index.html")
...
if __name__ == "__main__":
    generate_ultra_simple_dashboard()
